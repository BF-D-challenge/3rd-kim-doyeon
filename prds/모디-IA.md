...
> ⚠️ **2026-07-17 개정**: HTML 플로우 프로토타입(C0~G4)으로 상위 구조 확장 — **모디 루프**(미정 게시→확정→전원 알림→재방문)가 핵심 축. 확정 결정: ① RSVP(참석/불참/고민중) 유지 + **한마디** 필드 (이모지 반응 전환 폐기) ② 호스트만 계정(매직링크), 게스트 무가입. 최신 플로우는 `~/Documents/modi/modi-flow-prototype.html` + [2주차 정리](2주차.md) 참고 — 이 문서의 G1 "이모지 반응 바" 서술은 폐기됨.
